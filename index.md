...
Each capability maps to the engine feature branch in [godot](https://github.com/v-sekai-multiplayer-fabric/godot) that implements it, plus the supporting repos. The Tier column follows the [feature classification](decisions/20260606-feature-classification-poc-baseline-stretch.md): proof of concept, baseline, or stretch.
...
| Networking transport ([WebTransport / HTTP/3](decisions/20260606-presence-demo-networking-internals.md)) | Baseline         | `feat/module-http3` (picoquic + web/wasm backends)                                   | [zone-server](https://github.com/v-sekai-multiplayer-fabric/zone-server)                                                                                                                                                     | Working; `WebTransportPeer`/`QUICClient`/`QUICServer`, demos, Lean termination proof. |
...
| Spatial audio ([HRTF + audio probes](decisions/20260606-spatial-audio-patched-resonance-audio.md))       | Baseline         | `feat/spatial-audio-server`, `feat/module-resonance-audio` (patched Resonance Audio) | [sponza-godot-audio](https://github.com/v-sekai-multiplayer-fabric/sponza-godot-audio)                                                                                                                                       | Working; demo and benchmark scene.                                                    |
...
| Multiplayer presence ([tracker orbs](decisions/20260606-multiplayer-presence-demo-orbs.md))              | Proof of concept | `feat/module-xr-grid`                                                                | [xr-grid](https://github.com/v-sekai-multiplayer-fabric/xr-grid)                                                                                                                                                             | Proposed; head and hand pose orbs sent over low-level WebTransport.                   |
